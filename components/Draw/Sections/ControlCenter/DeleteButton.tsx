          ...
          <div className='flex flex-col items-center justify-center w-full h-full '>
            ...
            >
              <div className='z-50 flex flex-col items-center w-64 px-6 pb-6 bg-white rounded-lg shadow-lg h-80'>
                <Dialog.Title className='mb-6 text-lg text-center '>
                  <h1 className='top-0 flex items-center justify-center w-64 mb-2 text-2xl text-white bg-yellow-400 rounded-t-lg h-14 font-fancy '>
                    WAIT!!!
                  </h1>
                ...
                <button
                  className='w-40 p-2 mb-4 text-sm text-white bg-red-400 rounded-lg shadow-md hover:bg-red-500 hover:shadow-lg'
                  onClick={handleDelete}
                >
                  Delete Forever, Never to be Undone
                </button>
                <button
